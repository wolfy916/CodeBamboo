...
function Modal() {
  ...
  return (
    <div
      className={`${modalWrapperClasses} bgImg-bamboo items-start w-full h-full border-none z-40
                    md:w-4/5 md:h-4/5
    `}
    >
      <div
        className="wrapper bg-neutral-50/95 h-full w-full relative md:rounded-xl
      "
      >
        <header
